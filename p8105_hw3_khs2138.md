...
```
    ...
    ## # A tibble: 6 × 7
    ##    seqn sex     age   bmi education min   min_value
    ##   <dbl> <ord> <dbl> <dbl> <ord>     <chr>     <dbl>
    ## 1 62161 Male     22  23.3 hs_equiv  min1      1.11 
    ## 2 62161 Male     22  23.3 hs_equiv  min2      3.12 
    ## 3 62161 Male     22  23.3 hs_equiv  min3      1.47 
    ## 4 62161 Male     22  23.3 hs_equiv  min4      0.938
    ## 5 62161 Male     22  23.3 hs_equiv  min5      1.60 
    ## 6 62161 Male     22  23.3 hs_equiv  min6      0.145
...
<img src="p8105_hw3_khs2138_files/figure-gfm/unnamed-chunk-2-1.png" width="90%" />
